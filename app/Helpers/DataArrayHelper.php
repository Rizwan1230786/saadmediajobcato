...
class DataArrayHelper
{
    ...
    public static function adminCompaniesArray()
    {
        $array = Company::select('companies.name', 'companies.id')->Isadmin()->active()->pluck('companies.name', 'companies.id')->toArray();
        return $array;
        // return Company::select('companies.name', 'companies.id', 'companies.is_admin')->Isadmin()->active()->get()->toArray();
        // return Company::where('is_admin', 1)->get();
        // $array = Company::select('companies.name','companies.id', 'companies.is_admin')->where('companies.is_admin', '=', 1)->active()->pluck('companies.name', 'companies.id', 'companies.is_admin')->toArray();
        // return $array;
    }
