...
class CompanyController extends Controller
{
    ...
    public function storeCompany(CompanyFormRequest $request)
    {
        ...
        $company->is_admin = $request->input('company_type');
    ...
    public function editCompany($id)
    {
        ...
        if( !empty($company->id) ){
            ...
            foreach($verification_files as $index => $file){
                $verification_files[$index]->download = Storage::url($file->file_name);
            }
        }
    ...
    public function updateCompany($id, CompanyFormRequest $request)
    {
        ...
        $company->is_verification_cleared = $request->input('is_verification_cleared');
