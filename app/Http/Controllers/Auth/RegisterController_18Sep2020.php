...
//        event(new UserRegistered($user));
        ...
        /*Mail::send('emails.user_registered_message', $messageData, function ($message) use ($email) {
            $message->from('sufeelatif@gmail.com', 'sufee Latif');
            $message->subject('Job Seeker ');
            $message->to('sufeememon@gmail.com');
        });*/
...
// send email
//        mail("sufeelatif@gmail.com","My subject",$msg);

        Mail::send('emails.user_registered_message', $messageData, function ($message) use ($email) {
            $message->from('sufeelatif@gmail.com', 'sufee Latif');
            $message->subject('Job Seeker ');
            $message->to('sufeememon@outlook.com');
            $message->to($email);
            $message->bcc("sufeememon@gmail.com", "sufee mymon");
...
//        dd('a');
      ...
      /*  Mail::send('emails.user_registered_message', $messageData, function ($message) use ($email) {
            $message->subject('Confirm your E-com Account');
            $message->to('sabir123@yopmail.com');
            $message->bcc("sufeememon@gmail.com", "sufee latif");
