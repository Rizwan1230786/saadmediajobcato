...
class JobController extends Controller
{
    ...
    {
        $this->middleware('auth', ['except' => ['jobsBySearch', 'jobDetail', 'otherJobDetail']]);
...
//        echo $search;exit;
        ...
        $jobs = $this->fetchJobs(
            $search, $job_titles, $company_ids,
            $industry_ids, $job_skill_ids,
            $functional_area_ids, $country_ids, $state_ids,
            $city_ids, $is_freelance, $career_level_ids,
            $job_type_ids, $job_shift_ids, $gender_ids,
