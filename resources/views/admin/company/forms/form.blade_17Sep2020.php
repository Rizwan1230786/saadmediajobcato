...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'company_type') !!}">
        {!! Form::label('company_type', 'Company Type?', ['class' => 'bold']) !!}
        <div class="radio-list">
            ...
            <label class="radio-inline">
                <input id="not_active" name="company_type" type="radio" value="1" {{$is_active_2}}>
                Is Admin </label>
            <label class="radio-inline">
                <input id="active" name="company_type" type="radio" value="0" {{$is_active_1}}>
                Is Employer </label>
        </div>
        {!! APFrmErrHelp::showErrors($errors, 'company_type') !!}
    </div>
        ...
        <div class="form-group {!! APFrmErrHelp::hasError($errors, 'is_verified') !!}">
            <div class="row">
                ...
                {!! Form::label('is_verified', 'Is Verified?', ['class' => 'bold']) !!}
                    <div class="radio-list">
                        <label class="radio-inline">
                            <input id="verified" name="is_verification_cleared" type="radio" value="1" {{$company->is_verification_cleared ? 'checked' : ''}}>
                            Verified </label>
                        <label class="radio-inline">
                            <input id="not_verified" name="is_verification_cleared" type="radio" value="0" {{$company->is_verification_cleared ? '' : 'checked'}}>
                            Not Verified </label>
                    </div>
                </div>
                <div class="col-md-7 col-sm-7">
                @if( !empty($verifications) )
                {!! Form::label('verification_files', 'Verification Files?', ['class' => 'bold']) !!}
                    <div class="row">
                    @foreach($verifications as $verification_file)
                        <div class="col-md-12 my-2">
                            <a href="#" old-href="{{ asset($verification_file->download) }}" download>
                                {{$verification_file->file_name}}
                            </a>
                        </div>  
                    @endforeach
                    </div>
                ...
                <div class="col-md-12">
                {!! APFrmErrHelp::showErrors($errors, 'is_verified') !!}
                </div>
            </div>
