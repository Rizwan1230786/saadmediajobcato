                        ...
                        <div class="row">
                            <div class="col-md-8 col-sm-8">
                                ...
                                <div class="candidateinfo">
                                    <div class="userPic"><a
                                            href="{{ url('/company-in-' . $country->slug . '/' . $company->slug) }}">{{ $company->printCompanyImage() }}</a>
                                    </div>
                            ...
                            <ul class="searchList">
                                @if (isset($company->jobs) && count($company->jobs))
                                    @foreach ($company->jobs as $companyJob)
                                        <!--Job start-->
                                        {{-- @php
                                            $countries= App\Country::where('id',$companyJob->country_id)->get();
                                            
                                        @endphp --}}
                                        @if ($companyJob->country_id == $country->id)
                                            <li>
                                                <div class="row">
                                                    <div class="col-md-8 col-sm-8">
                                                        <div class="jobimg"><a
                                                                href="{{ url('jobdetail' . '/' . $companyJob->slug . '_in_' . $country->country) }}"
                                                                title="{{ $companyJob->title }}">
                                                                {{ $company->printCompanyImage() }} </a></div>
                                                        <div class="jobinfo">
                                                            <h3><a href="{{ url('jobdetail' . '/' . $companyJob->slug . '_in_' . $country->slug) }}"
                                                                    title="{{ $companyJob->title }}">{{ $companyJob->title }}</a>
                                                            </h3>
                                                            <div class="companyName"><a
                                                                    href="{{ url('jobdetail' . '/' . $companyJob->slug . '_in_' . $country->slug) }}"
                                                    ...
                                                    <div class="col-md-4 col-sm-4">
                                                        <div class="listbtn"><a
                                                                href="{{ url('jobdetail' . '/' . $companyJob->slug . '_in_' . $country->slug) }}">{{ __('View Detail') }}</a>
                                                        </div>
                                                    </div>
                                                </div>
