            ...
            <div class="col-md-3 col-sm-6">
                ...
                <ul class="quicklinks">
                    ...
                    @foreach ($functionalAreas as $functionalArea)
                        @if (!empty($country))
                            <li><a
                                    href="{{ url('functional_area_id'.'-'.$functionalArea->functional_area_id.'/jobs-in-'.$country->slug) }}">{{ $functionalArea->functional_area }}</a>
                            </li>
                        @else
                            <li><a
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <ul class="quicklinks">
                    ...
                    @foreach ($industries as $industry)
                        <li><a
                                href="{{ url('industry_id'.'-'.$industry->industry_id.'/jobs-in-'.$country->slug) }}">{{ $industry->industry }}</a>
                        </li>
                    @endforeach
                </ul>
                <!--Industry menu End-->
