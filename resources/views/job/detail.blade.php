                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="companyinfo">
                            ...
                            <div class="title"><a
                                    href="{{ url('company-detail'.'/'.$company->slug.'_in_'.$country->slug) }}">{{ $company->name }}</a></div>
                            <div class="ptext">{{ $company->getLocation() }}</div>
                            <div class="opening">
                                <a href="{{ url('company-detail'.'/'.$company->slug.'_in_'.$country->slug) }}">
                            ...
                            <div class="companyoverview">
                                ...
                                <p>{{ str_limit(strip_tags($company->description), 250, '...') }} <a
                                        href="{{ url('company-detail'.'/'.$company->slug.'_in_'.$country->country) }}">Read More</a></p>
                            </div>
                        </div>
                            ...
                            <ul class="searchList">
                                @if (isset($relatedJobs) && count($relatedJobs))
                                    @foreach ($relatedJobs as $relatedJob)
                                        @if ($relatedJob->country_id == $country->id)
                                            <?php $relatedJobCompany = $relatedJob->getCompany(); ?>
                                            @if (null !== $relatedJobCompany)
                                                <!--Job start-->
                                                <li>
                                                    <div class="jobinfo">
                                                        <h3><a href="{{ url('jobdetail'.'/'.$relatedJob->slug.'_in_'.$country->slug) }}"
                                                                title="{{ $relatedJob->title }}">{{ $relatedJob->title }}</a>
                                                        </h3>
                                                        @if($relatedJobCompany->country_id == $country->id)
                                                        <div class="companyName"><a
                                                                href="{{ url('company-detail'.'/'.$relatedJobCompany->slug.'_in_'.$country->slug) }}"
