...
<div class="row">  
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'industrial_id') !!}" id="industrial_id_div"> {!! Form::select('industrial_id', ['' => __('Select Industrial Area')]+$induxtrialAreas, null, array('class'=>'form-control', 'id'=>'industrial_id')) !!}
            {!! APFrmErrHelp::showErrors($errors, 'industrial_id') !!} </div>
    </div>
    <div class="col-md-6">
