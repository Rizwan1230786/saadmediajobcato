                ...
                <div class="col-lg-6 col-sm-12">
                    ...
                    <ul class="searchList">
                        ...
                        <li>
                            <div class="row">
                                <div class="col-md-8 col-sm-8">
                                    <div class="jobimg">{{ ImgUploader::print_image("other_jobs/$job->logo", 100, 100) }}</div>
                                    <div class="jobinfo">
                                        <h3><a href="{{route('other.job.detail', [$job->id])}}" title="{{$job->title}}">{{$job->title}}</a></h3>
                                        <div class="companyName"><a href="#" target="_blank" title="">{{$job->company_name}}</a></div>
                                        <div class="location">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="listbtn"><a href="{{route('other.job.detail', [$job->id])}}">{{__('View Details')}}</a></div>
                                </div>
                            </div>
                            <p>{{str_limit(strip_tags($job->description), 150, '...')}}</p>
                        </li>
                    ...
                    <ul class="searchList">
                        ...
                        <li>
                            <div class="row">
                                <div class="col-md-8 col-sm-8">
                                    <div class="jobimg"><img src="{{url('public/custom_jobs/'.$customjob->image)}}"  style="max-width=100px; max-height:100px;"alt=""></div>
{{--                                    <div class="jobimg">{{ ImgUploader::print_image("custom_jobs/$customjob->logo", 100, 100) }}</div>--}}
                                    <div class="jobinfo">
                                        <h3><a href="{{route('custom.job.details', [$customjob->id])}}" title="{{$customjob->title}}">{{$customjob->title}}</a></h3>
                                        <div class="companyName"><a href="#" target="_blank" title="">{{$customjob->company_name}}</a></div>
                                        <div class="location">
                                            <label class="fulltime" title="#">{{$customjob->job_type}}</label>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <div class="listbtn"><a href="{{route('custom.job.details', [$customjob->id])}}">{{__('View Details')}}</a></div>
                                </div>
                            </div>
