...
Route::post('update-front-profile-video/{id}', 'UserController@updateProfileVideo')->name('update.front.profile.video');

Route::post('update-front-profile-get-video/{id}', 'UserController@getUserData')->name('update.front.profile.get.video');
