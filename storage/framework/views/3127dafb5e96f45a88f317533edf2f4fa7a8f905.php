<h5 id="cvs" onclick="showCvs();"><?php echo e(__('Curriculum vitae')); ?></h5>
...
<a href="javascript:;" onclick="showProfileCvModal();"> <?php echo e(__('Add CV')); ?> </a>
...
<script type="text/javascript">
    ...
    type: "POST",
            ...
            url: "<?php echo e(route('get.front.profile.cv.form', $user->id)); ?>",
    ...
    type: "POST",
            ...
            url: "<?php echo e(route('get.front.profile.cv.edit.form', $user->id)); ?>",

            data: {"cv_id": cv_id, "_token": "<?php echo e(csrf_token()); ?>"},
    ...
    $.post("<?php echo e(route('show.front.profile.cvs', $user->id)); ?>", {user_id: <?php echo e($user->id); ?>, _method: 'POST', _token: '<?php echo e(csrf_token()); ?>'})
    ...
    $.post("<?php echo e(route('delete.front.profile.cv')); ?>", {id: id, _method: 'DELETE', _token: '<?php echo e(csrf_token()); ?>'})
