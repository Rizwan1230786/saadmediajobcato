<li class="nav-item  "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-bar-chart" aria-hidden="true"></i> <span class="title">Language Levels</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
...
</li><?php /**PATH C:\xampp\htdocs\saadmediajobcato\resources\views/admin/shared/side_bars/language_level.blade.php ENDPATH**/ ?>