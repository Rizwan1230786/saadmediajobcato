    ...
    <div class="page-content" style="background-color:#eef1f5;"> 
        ...
        <div class="row">
            <div class="col-md-12 col-sm-6">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12"> <a class="dashboard-stat dashboard-stat-v2 green dark-black" href="#">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12"> <a class="dashboard-stat dashboard-stat-v2 red dark-green" href="#">
                        <div class="visual"> <i class="fa fa-user"></i> </div>
                        <div class="details">
            ...
            <div class="col-md-12 col-sm-6">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12"> <a class="dashboard-stat dashboard-stat-v2 red dark-blue" href="#">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12"> <a class="dashboard-stat dashboard-stat-v2 blue dark-yellow" href="#">
                        <div class="visual"> <i class="fa fa-list"></i> </div>
                        <div class="details">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12"> <a class="dashboard-stat dashboard-stat-v2 purple last-stat" href="#">
                        <div class="visual"> <i class="fa fa-list"></i> </div>
                        <div class="details">
                            ...
                            <ul class="feeds">
                                ...
                                <li>
                                    <div class="col1">
                                        <div class="cont">
                                            <div class="cont-col1">
                                                <div class="label label-sm label-info label-info-custom"> <i class="fa fa-check"></i> </div>
                                            </div>
                                            <div class="cont-col2">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\saadmediajobcato\resources\views/admin/home.blade.php ENDPATH**/ ?>