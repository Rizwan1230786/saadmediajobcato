...
<div class="form-body">        
    ...
    <div class="form-group <?php echo APFrmErrHelp::hasError($errors, 'skills'); ?>">
        <?php echo Form::label('skills', 'Job skills', ['class' => 'bold']); ?>
        ...
        <?php echo APFrmErrHelp::showErrors($errors, 'skills'); ?>
    ...
    <div class="form-group <?php echo APFrmErrHelp::hasError($errors, 'is_freelance'); ?>">
        <?php echo Form::label('is_freelance', 'Is Freelance?', ['class' => 'bold']); ?>
        ...
        <?php echo APFrmErrHelp::showErrors($errors, 'is_freelance'); ?>

    </div>
    <div class="form-group <?php echo APFrmErrHelp::hasError($errors, 'career_level_id'); ?>" id="career_level_id_div">
    ...
    <div class="form-group <?php echo APFrmErrHelp::hasError($errors, 'salary_from'); ?>" id="salary_from_div">
        <?php echo Form::label('salary_from', 'Salary From', ['class' => 'bold']); ?>                    
        <?php echo Form::number('salary_from', null, array('class'=>'form-control', 'id'=>'salary_from')); ?>

        <?php echo APFrmErrHelp::showErrors($errors, 'salary_from'); ?>                                       
    </div>
    <div class="form-group <?php echo APFrmErrHelp::hasError($errors, 'salary_to'); ?>" id="salary_to_div">
        <?php echo Form::label('salary_to', 'Salary To', ['class' => 'bold']); ?>                    
        <?php echo Form::number('salary_to', null, array('class'=>'form-control', 'id'=>'salary_to')); ?>

        <?php echo APFrmErrHelp::showErrors($errors, 'salary_to'); ?>                                       
    </div>
    <div class="form-group <?php echo APFrmErrHelp::hasError($errors, 'salary_currency'); ?>" id="salary_currency_div">
        <?php echo Form::label('salary_currency', 'Salary Currency', ['class' => 'bold']); ?>                    
        <?php echo Form::select('salary_currency', ['' => 'Select Salary Currency']+$currencies, null, array('class'=>'form-control', 'id'=>'salary_currency')); ?>

        <?php echo APFrmErrHelp::showErrors($errors, 'salary_currency'); ?>                                       
    </div>
    <div class="form-group <?php echo APFrmErrHelp::hasError($errors, 'salary_period_id'); ?>" id="salary_period_id_div">
        <?php echo Form::label('salary_period_id', 'Salary Period', ['class' => 'bold']); ?>                    
        <?php echo Form::select('salary_period_id', ['' => 'Select Salary Period']+$salaryPeriods, null, array('class'=>'form-control', 'id'=>'salary_period_id')); ?>

        <?php echo APFrmErrHelp::showErrors($errors, 'salary_period_id'); ?>                                       
    </div>
    <div class="form-group <?php echo APFrmErrHelp::hasError($errors, 'hide_salary'); ?>">
        <?php echo Form::label('hide_salary', 'Hide Salary?', ['class' => 'bold']); ?>
        ...
        <?php echo APFrmErrHelp::showErrors($errors, 'hide_salary'); ?>
    ...
    <div class="form-group <?php echo APFrmErrHelp::hasError($errors, 'job_type_id'); ?>" id="job_type_id_div">
        <?php echo Form::label('job_type_id', 'Job Type', ['class' => 'bold']); ?>                    
        <?php echo Form::select('job_type_id', ['' => 'Select Job Type']+$jobTypes, null, array('class'=>'form-control', 'id'=>'job_type_id')); ?>

        <?php echo APFrmErrHelp::showErrors($errors, 'job_type_id'); ?>                                       
    </div>
    <div class="form-group <?php echo APFrmErrHelp::hasError($errors, 'job_shift_id'); ?>" id="job_shift_id_div">
        <?php echo Form::label('job_shift_id', 'Job Shift', ['class' => 'bold']); ?>                    
        <?php echo Form::select('job_shift_id', ['' => 'Select Job Shift']+$jobShifts, null, array('class'=>'form-control', 'id'=>'job_shift_id')); ?>

        <?php echo APFrmErrHelp::showErrors($errors, 'job_shift_id'); ?>                                       
    </div>
    <div class="form-group <?php echo APFrmErrHelp::hasError($errors, 'num_of_positions'); ?>" id="num_of_positions_div">
        <?php echo Form::label('num_of_positions', 'Positions#', ['class' => 'bold']); ?>                    
        <?php echo Form::select('num_of_positions', ['' => 'Select Positions#']+MiscHelper::getNumPositions(), null, array('class'=>'form-control', 'id'=>'num_of_positions')); ?>

        <?php echo APFrmErrHelp::showErrors($errors, 'num_of_positions'); ?>                                       
    </div>
    <div class="form-group <?php echo APFrmErrHelp::hasError($errors, 'gender_id'); ?>" id="gender_id_div">
        <?php echo Form::label('gender_id', 'Gender', ['class' => 'bold']); ?>                    
        <?php echo Form::select('gender_id', ['' => __('No preference')]+$genders, null, array('class'=>'form-control', 'id'=>'gender_id')); ?>

        <?php echo APFrmErrHelp::showErrors($errors, 'gender_id'); ?>                                       
    </div>
    <div class="form-group <?php echo APFrmErrHelp::hasError($errors, 'expiry_date'); ?>">
        <?php echo Form::label('expiry_date', 'Job expiry date', ['class' => 'bold']); ?>

        <?php echo Form::text('expiry_date', null, array('class'=>'form-control datepicker', 'id'=>'expiry_date', 'placeholder'=>'Job expiry date', 'autocomplete'=>'off')); ?>

        <?php echo APFrmErrHelp::showErrors($errors, 'expiry_date'); ?>

    </div>
    <div class="form-group <?php echo APFrmErrHelp::hasError($errors, 'degree_level_id'); ?>" id="degree_level_id_div">
        <?php echo Form::label('degree_level_id', 'Required Degree Level', ['class' => 'bold']); ?>                    
        <?php echo Form::select('degree_level_id', ['' => 'Select Required Degree Level']+$degreeLevels, null, array('class'=>'form-control', 'id'=>'degree_level_id')); ?>
    ...
    <div class="form-group <?php echo APFrmErrHelp::hasError($errors, 'job_experience_id'); ?>" id="job_experience_id_div">
        <?php echo Form::label('job_experience_id', 'Required job experience', ['class' => 'bold']); ?>                    
        <?php echo Form::select('job_experience_id', ['' => 'Select Required job experience']+$jobExperiences, null, array('class'=>'form-control', 'id'=>'job_experience_id')); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\saadmediajobcato\resources\views/admin/job/forms/form.blade.php ENDPATH**/ ?>