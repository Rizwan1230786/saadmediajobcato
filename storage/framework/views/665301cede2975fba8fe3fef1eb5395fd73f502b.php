                ...
                <div class="userccount">
                    ...
                    <div class="userbtns">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item"><a class="nav-link <?php echo e(($c_or_e == 'candidate')? 'active':''); ?>"
                                                    data-toggle="tab" href="#candidate"
                                                    aria-expanded="true"><?php echo e(__('Candidate')); ?></a></li>

                            <li class="nav-item"><a class="nav-link <?php echo e(($c_or_e == 'employer')? 'active':''); ?>"
                                                    data-toggle="tab" href="#employer"
                                                    aria-expanded="false"><?php echo e(__('Employer')); ?></a></li>
                        ...
                        <div id="candidate" class="formpanel tab-pane <?php echo e(($c_or_e == 'candidate')? 'active':''); ?>">
                            ...
                            <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>">
                                ...
                                <div class="formrow<?php echo e($errors->has('first_name') ? ' has-error' : ''); ?>">
                                    ...
                                    <?php if($errors->has('first_name')): ?> <span
                                            class="help-block"> <strong><?php echo e($errors->first('first_name')); ?></strong> </span> <?php endif; ?>
                                </div>
                                ...
                                <div class="formrow<?php echo e($errors->has('middle_name') ? ' has-error' : ''); ?>">
                                    ...
                                    <?php if($errors->has('middle_name')): ?> <span
                                            class="help-block"> <strong><?php echo e($errors->first('middle_name')); ?></strong> </span> <?php endif; ?>
                                </div>
                                ...
                                <div class="formrow<?php echo e($errors->has('last_name') ? ' has-error' : ''); ?>">
                                    ...
                                    <?php if($errors->has('last_name')): ?> <span
                                            class="help-block"> <strong><?php echo e($errors->first('last_name')); ?></strong> </span> <?php endif; ?>
                                </div>
                                ...
                                <div class="formrow<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                                    ...
                                    <?php if($errors->has('email')): ?> <span
                                            class="help-block"> <strong><?php echo e($errors->first('email')); ?></strong> </span> <?php endif; ?>
                                </div>
                                ...
                                <div class="formrow<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                                    ...
                                    <?php if($errors->has('password')): ?> <span
                                            class="help-block"> <strong><?php echo e($errors->first('password')); ?></strong> </span> <?php endif; ?>
                                </div>
                                ...
                                <div class="formrow<?php echo e($errors->has('password_confirmation') ? ' has-error' : ''); ?>">
                                    ...
                                    <?php if($errors->has('password_confirmation')): ?> <span
                                            class="help-block"> <strong><?php echo e($errors->first('password_confirmation')); ?></strong> </span> <?php endif; ?>
                                </div>
                                ...
                                <div class="formrow<?php echo e($errors->has('is_subscribed') ? ' has-error' : ''); ?>">
                                    ...
                                    <input type="checkbox" value="1"
                                           name="is_subscribed" <?php echo e($is_checked); ?> /><?php echo e(__('Subscribe to news letter')); ?>


                                    <?php if($errors->has('is_subscribed')): ?> <span
                                            class="help-block"> <strong><?php echo e($errors->first('is_subscribed')); ?></strong> </span> <?php endif; ?>
                                </div>
                                ...
                                <div class="formrow<?php echo e($errors->has('terms_of_use') ? ' has-error' : ''); ?>">
                                    ...
                                    <?php if($errors->has('terms_of_use')): ?> <span
                                            class="help-block"> <strong><?php echo e($errors->first('terms_of_use')); ?></strong> </span> <?php endif; ?>
                                </div>
                        ...
                        <div id="employer" class="formpanel tab-pane fade <?php echo e(($c_or_e == 'employer')? 'active':''); ?>">
                            ...
                            <form class="form-horizontal" method="POST" action="<?php echo e(route('company.register')); ?>">
                                ...
                                <div class="formrow<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                                    ...
                                    <?php if($errors->has('name')): ?> <span
                                            class="help-block"> <strong><?php echo e($errors->first('name')); ?></strong> </span> <?php endif; ?>
                                </div>
                    ...
                    <div class="newuser"><i class="fa fa-user" aria-hidden="true"></i> <?php echo e(__('Have Account')); ?>? <a
                                href="<?php echo e(route('login')); ?>"><?php echo e(__('Sign in')); ?></a></div>
