        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-8"> 
                        ...
                        <div class="userccount">
                            <div class="formpanel mt0"> <?php echo $__env->make('flash::message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> 
                        ...
                        <div class="userccount">
                            <div class="formpanel mt0"
                                <!-- Personal Information -->
                                <?php echo $__env->make('user.inc.video', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>                                
                            </div>
                        </div>
						 <div class="userccount">
                            <div class="formpanel mt0">
                                <!-- Personal Information -->
                                <?php echo $__env->make('user.forms.cv.cvs', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
