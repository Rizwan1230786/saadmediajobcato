                ...
                <div class="col-lg-6 col-sm-12"> 
                    ...
                    <ul class="searchList">
                        ...
                        <?php if(isset($jobs) && count($jobs)): ?> 
                            <?php $count_1 = 1; ?> 
                            <?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php $company =
                                $job->getCompany();  ?>
                        ...
                        <li>
                            <div class="row">
                                <div class="col-md-8 col-sm-8">
                                    ...
                                    <div class="jobinfo">
                                        <h3><a href="<?php echo e(route('other.job.detail', [$job->id])); ?>" title="<?php echo e($job->title); ?>"><?php echo e($job->title); ?></a></h3>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="listbtn"><a href="<?php echo e(route('other.job.detail', [$job->id])); ?>"><?php echo e(__('View Details')); ?></a></div>
                                </div>
                            </div>
                            <p><?php echo e(str_limit(strip_tags($job->description), 150, '...')); ?></p>
                        </li>
                    ...
                    <ul class="searchList">
                        ...
                        <li>
                            <div class="row">
                                <div class="col-md-8 col-sm-8">
                                    <div class="jobimg"><img src="<?php echo e(url('public/custom_jobs/'.$customjob->image)); ?>"  style="max-width=100px; max-height:100px;"alt=""></div>

                                    <div class="jobinfo">
                                        <h3><a href="<?php echo e(route('custom.job.details', [$customjob->id])); ?>" title="<?php echo e($customjob->title); ?>"><?php echo e($customjob->title); ?></a></h3>
                                        <div class="companyName"><a href="#" target="_blank" title=""><?php echo e($customjob->company_name); ?></a></div>
                                        <div class="location">
                                            <label class="fulltime" title="#"><?php echo e($customjob->job_type); ?></label>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <div class="listbtn"><a href="<?php echo e(route('custom.job.details', [$customjob->id])); ?>"><?php echo e(__('View Details')); ?></a></div>
                                </div>
                            </div>
