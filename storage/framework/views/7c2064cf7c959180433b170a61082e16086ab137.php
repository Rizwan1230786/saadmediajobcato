<div class="header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-2 col-md-12 col-12"> <a href="<?php echo e(url('/jobs-in-'.$country->slug)); ?>" class="logo"><img src="<?php echo e(asset('/')); ?>sitesetting_images/thumb/<?php echo e($siteSetting->site_logo); ?>" alt="<?php echo e($siteSetting->site_name); ?>" /></a>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse collapse" id="nav-main">
                        <ul class="navbar-nav ml-auto">
                            <li class="nav-item <?php echo e(Request::url() == route('index') ? 'active' : ''); ?>"><a href="<?php echo e(url('/jobs-in-'.$country->slug)); ?>" class="nav-link"><?php echo e(__('Home')); ?></a> </li>
							
                            
							

							<li class="nav-item <?php echo e(Request::url()); ?>"><a href="<?php echo e(url('/companies-in-'.$country->slug)); ?>" class="nav-link"><?php echo e(__('Companies')); ?></a> </li>
                            ...
                            <li class="nav-item dropdown userbtn"><a href=""><?php echo e(Auth::guard('company')->user()->printCompanyImage()); ?></a>
                                <ul class="dropdown-menu">
                                    ...
                                    <!-- <li class="nav-item"><a href="#" class="nav-link"><i class="fa fa-envelope-o" aria-hidden="true"></i> <?php echo e(__('Company Messages')); ?></a></li> -->
...
@endif<?php */?><?php /**PATH C:\xampp\htdocs\saadmediajobcato\resources\views/includes/countryheader.blade.php ENDPATH**/ ?>