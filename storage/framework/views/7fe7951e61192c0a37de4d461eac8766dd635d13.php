    ...
    <div class="container"> 
        ...
        <div class="job-header">
            <div class="jobinfo">
                        ...
                        <a href="<?php echo e(route('login')); ?>"><i class="fa fa-sign-in" aria-hidden="true"></i> <?php echo e(__('Login to View Salary')); ?> </a>
						<?php else: ?>
						<?php if(!(bool)$job->hide_salary): ?>
                        <div class="salary"><?php echo e(__('Monthly Salary')); ?>: <strong><?php echo e($job->salary_from.' '.$job->salary_currency); ?> - <?php echo e($job->salary_to.' '.$job->salary_currency); ?></strong></div>
                        <?php endif; ?>
						<?php endif; ?>
                    ...
                    <div class="jobdetail">
                       <h3><i class="fa fa-align-left" aria-hidden="true"></i> <?php echo e(__('Job Detail')); ?></h3>
                            ...
                            <li class="row">
                                ...
                                <div class="col-md-8 col-xs-7"><span><?php echo e($job->expiry_date->format('M d, Y')); ?></span></div>
                            </li> 
            ...
            <div class="col-lg-5"> 
                ...
                <span class="jbexpire"><i class="fa fa-paper-plane" aria-hidden="true"></i> <?php echo e(__('Job is expired')); ?></span>
                <?php elseif(Auth::check() && Auth::user()->isAppliedOnJob($job->id)): ?>
                <a href="javascript:;" class="btn apply applied"><i class="fa fa-paper-plane" aria-hidden="true"></i> <?php echo e(__('Already Applied')); ?></a>
                <?php else: ?>
				...
				<div class="companyoverview">
					...
					<p><?php echo e(str_limit(strip_tags($company->description), 250, '...')); ?> <a href="<?php echo e(route('company.detail',$company->slug)); ?>">Read More</a></p>
					</div>
                        </div>
                    ...
                    <ul class="searchList">
                        ...
                        <li>
                                    ...
                                    <div class="jobinfo">
										...
										<div class="location"><span><?php echo e($relatedJob->getCity('city')); ?></span></div>
                                        <div class="location">
                                            <label class="fulltime"><?php echo e($relatedJob->getJobType('job_type')); ?></label>
                                            <label class="partTime"><?php echo e($relatedJob->getJobShift('job_shift')); ?></label> </div>
                                    </div>
                                    <div class="clearfix"></div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\JobCato\resources\views/job/detail.blade.php ENDPATH**/ ?>