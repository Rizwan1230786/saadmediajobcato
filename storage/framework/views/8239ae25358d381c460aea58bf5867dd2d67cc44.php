...
<section id="joblisting-header" role="search" class="searchform">
            <form id="top-search" method="GET" action="<?php echo e(route('company.listing')); ?>">
                <div class="row">                    
                    <div class="col-lg-9">
						<input type="text" name="search" value="<?php echo e(Request::get('search', '')); ?>" class="form-control search" placeholder="<?php echo e(__('keywords e.g. "Google"')); ?>" />
                    </div>
                    <div class="col-lg-3">
    ...
    <ul class="row compnaieslist">
	 ...
	 <div class="pagiWrap">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="showreslt">
                                    <?php echo e(__('Showing Pages')); ?> : <?php echo e($companies->firstItem()); ?> - <?php echo e($companies->lastItem()); ?> <?php echo e(__('Total')); ?> <?php echo e($companies->total()); ?>
