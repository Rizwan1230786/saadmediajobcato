<li class="nav-item  "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-black-tie" aria-hidden="true"></i> <span class="title">Job Shifts</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
...
</li><?php /**PATH C:\xampp\htdocs\saadmediajobcato\resources\views/admin/shared/side_bars/job_shift.blade.php ENDPATH**/ ?>