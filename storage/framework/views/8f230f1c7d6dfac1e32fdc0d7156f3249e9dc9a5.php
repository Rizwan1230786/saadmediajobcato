<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('includes.inner_page_title', ['page_title' => __('Company Detail')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="job-header">
                        ...
                        <div class="row">
                            <div class="col-md-8 col-sm-8">
                                ...
                                <div class="candidateinfo">
                                    <div class="userPic"><a
                                            href="<?php echo e(url('/company-in-' . $country->slug . '/' . $company->slug)); ?>"><?php echo e($company->printCompanyImage()); ?></a>
                                    </div>
                                ...
                                <?php if($company->is_verification_cleared): ?>
                                    <h5 class="m-0 mt-2 text-bold text-success"><i
                                            class="fa fa-check-circle text-success"></i>&nbsp; Verified</h5>
                                <?php endif; ?>
                            </div>
                                    ...
                                    <div class="candidateinfo">
                                        <?php if(!empty($company->phone)): ?>
                                            <div class="loctext"><i class="fa fa-phone" aria-hidden="true"></i> <a
                                                    href="tel:<?php echo e($company->phone ?? ''); ?>"><?php echo e($company->phone ?? ''); ?></a>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if(!empty($company->website)): ?>
                                            <div class="loctext"><i class="fa fa-globe" aria-hidden="true"></i> <a
                                                    href="<?php echo e($company->website); ?>"
                                                    target="_blank"><?php echo e($company->website); ?></a>
                                            </div>
                                        <?php endif; ?>
                    ...
                    <div class="jobButtons">
                        <?php if(Auth::check() && Auth::user()->isFavouriteCompany($company->slug)): ?>
                            <a href="<?php echo e(route('remove.from.favourite.company', $company->slug)); ?>" class="btn"><i
                                    class="fa fa-floppy-o" aria-hidden="true"></i> <?php echo e(__('Favourite Company')); ?> </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('add.to.favourite.company', $company->slug)); ?>" class="btn"><i
                        ...
                        <!-- <a
                                    href="<?php echo e(route('report.abuse.company', $company->slug)); ?>" class="btn report"><i
                                        class="fa fa-exclamation-triangle" aria-hidden="true"></i> <?php echo e(__('Report Abuse')); ?></a> -->
                        <!--   <a href="javascript:;" onclick="send_message()" class="btn"><i class="fa fa-envelope"
                                        aria-hidden="true"></i> <?php echo e(__('Send Message')); ?></a> -->
                    </div>
                </div>
            <?php else: ?>
                <div class="job-header">
                            ...
                            <ul class="searchList">
                                <?php if(isset($company->jobs) && count($company->jobs)): ?>
                                    <?php $__currentLoopData = $company->jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $companyJob): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if($companyJob->country_id == $country->id): ?>
                                            <li>
                                                <div class="row">
                                                    <div class="col-md-8 col-sm-8">
                                                        <div class="jobimg"><a
                                                                href="<?php echo e(url('jobdetail' . '/' . $companyJob->slug . '_in_' . $country->country)); ?>"
                                                                title="<?php echo e($companyJob->title); ?>">
                                                                <?php echo e($company->printCompanyImage()); ?> </a></div>
                                                        <div class="jobinfo">
                                                            <h3><a href="<?php echo e(url('jobdetail' . '/' . $companyJob->slug . '_in_' . $country->slug)); ?>"
                                                                    title="<?php echo e($companyJob->title); ?>"><?php echo e($companyJob->title); ?></a>
                                                            </h3>
                                                            <div class="companyName"><a
                                                                    href="<?php echo e(url('jobdetail' . '/' . $companyJob->slug . '_in_' . $country->slug)); ?>"
                                                    ...
                                                    <div class="col-md-4 col-sm-4">
                                                        <div class="listbtn"><a
                                                                href="<?php echo e(url('jobdetail' . '/' . $companyJob->slug . '_in_' . $country->slug)); ?>"><?php echo e(__('View Detail')); ?></a>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <ul class="jbdetail">
                                    <li class="row">
                                        ...
                                        <div class="col-md-6 col-xs-6">
                                            <span><?php echo e(((bool) $company->verified) ? 'Yes' : 'No'); ?></span>
                                        </div>
                                    </li>
                                    <li class="row">
                                    ...
                                    <li class="row">
                                        ...
                                        <div class="col-md-6 col-xs-6">
                                            <span><?php echo e($company->countNumJobs('company_id', $company->id)); ?></span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <?php $__currentLoopData = $company->jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $companyJob): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="col-md-8 col-sm-8">
                                                    <div class="jobimg"><a
                                                            href="<?php echo e(route('job.detail', [$companyJob->slug])); ?>"
                                                            title="<?php echo e($companyJob->title); ?>">
                                                            <?php echo e($company->printCompanyImage()); ?> </a></div>
                                                    <div class="jobinfo">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\saadmediajobcato\resources\views/company/detail.blade.php ENDPATH**/ ?>