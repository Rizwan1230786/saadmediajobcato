<li class="nav-item  "> <a href="javascript:;" class="nav-link nav-toggle"> <i class="fa fa-mars-double" aria-hidden="true"></i> <span class="title">Marital Statuses</span> <span class="arrow"></span> </a>
    <ul class="sub-menu">
...
</li><?php /**PATH C:\xampp\htdocs\saadmediajobcato\resources\views/admin/shared/side_bars/marital_status.blade.php ENDPATH**/ ?>