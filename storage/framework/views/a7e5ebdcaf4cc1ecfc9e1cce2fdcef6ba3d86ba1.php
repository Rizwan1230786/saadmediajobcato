                    ...
                    <td class="row" valign="top" style="padding-left:12px;padding-right:12px;padding-top:18px;padding-bottom:12px"><table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                            <tr>
                                <td class="subtitle" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:22px;font-weight:400;color:#333;padding-bottom:30px; text-align: left;">
                                    <p>Employer/Company with name "<?php echo e($name); ?>" has posted new job on "<?php echo e($siteSetting->site_name); ?>"</p>                  
                                    <p>
                                        <br>
                                        Front link :
...
<?php echo $__env->make('admin.layouts.email_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\JobCato\resources\views/emails/job_posted_message.blade.php ENDPATH**/ ?>