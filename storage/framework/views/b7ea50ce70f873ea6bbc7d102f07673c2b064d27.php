...
<h5><?php echo e(__('Account Information')); ?></h5>
<div class="row">
<div class="col-md-6">
...
<div class="row">
    <div class="col-md-6">
        <div class="formrow">
			<label><?php echo e(__('Profile Image')); ?></label>
			<?php echo e(ImgUploader::print_image("user_images/$user->image", 100, 100)); ?> </div>
    </div>
    <div class="col-md-6">
        <div class="formrow">
...
<div class="row">
    <div class="col-md-6">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'first_name'); ?>">
    ...
    <div class="col-md-6">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'middle_name'); ?>">
			<label for=""><?php echo e(__('Midlle Name')); ?></label>
    ...
    <div class="col-md-6">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'last_name'); ?>">
    ...
    <div class="col-md-6">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'father_name'); ?>">
    ...
    <div class="col-md-6">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'gender_id'); ?>">
			<label for=""><?php echo e(__('Gender')); ?></label>
			<?php echo Form::select('gender_id', [''=>__('Select Gender')]+$genders, null, array('class'=>'form-control', 'id'=>'gender_id')); ?>

            <?php echo APFrmErrHelp::showErrors($errors, 'gender_id'); ?> </div>
    </div>
    <div class="col-md-6">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'marital_status_id'); ?>">
			<label for=""><?php echo e(__('Martial Status')); ?></label>
			<?php echo Form::select('marital_status_id', [''=>__('Select Marital Status')]+$maritalStatuses, null, array('class'=>'form-control', 'id'=>'marital_status_id')); ?>
    ...
    <div class="col-md-6">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'state_id'); ?>">
			...
			<span id="state_dd"> <?php echo Form::select('state_id', [''=>__('Select State')], null, array('class'=>'form-control', 'id'=>'state_id')); ?> </span> <?php echo APFrmErrHelp::showErrors($errors, 'state_id'); ?> </div>
    </div>
    <div class="col-md-6">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'city_id'); ?>">
			<label for=""><?php echo e(__('City')); ?></label>
			<span id="city_dd"> <?php echo Form::select('city_id', [''=>__('Select City')], null, array('class'=>'form-control', 'id'=>'city_id')); ?> </span> <?php echo APFrmErrHelp::showErrors($errors, 'city_id'); ?> </div>
    </div>
    <div class="col-md-6">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'nationality_id'); ?>">
			<label for=""><?php echo e(__('Nationality')); ?></label>
			<?php echo Form::select('nationality_id', [''=>__('Select Nationality')]+$nationalities, null, array('class'=>'form-control', 'id'=>'nationality_id')); ?>

            <?php echo APFrmErrHelp::showErrors($errors, 'nationality_id'); ?> </div>
    </div>
    <div class="col-md-6">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'date_of_birth'); ?>">
			<label for=""><?php echo e(__('Date of Birth')); ?></label>
    ...
    <div class="col-md-6">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'national_id_card_number'); ?>">
			<label for=""><?php echo e(__('National ID')); ?></label>
			<?php echo Form::text('national_id_card_number', null, array('class'=>'form-control', 'id'=>'national_id_card_number', 'placeholder'=>__('National ID Card#'))); ?>
    ...
    <div class="col-md-6">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'mobile_num'); ?>">
			<label for=""><?php echo e(__('Mobile')); ?></label>
    ...
    <div class="col-md-12">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'street_address'); ?>">
			<label for=""><?php echo e(__('Street Address')); ?></label>
...
<h5><?php echo e(__('Career Information')); ?></h5>

<div class="row">
 <div class="col-md-6">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'job_experience_id'); ?>">
			<label for=""><?php echo e(__('Job Experience')); ?></label>
			<?php echo Form::select('job_experience_id', [''=>__('Select Experience')]+$jobExperiences, null, array('class'=>'form-control', 'id'=>'job_experience_id')); ?>

            <?php echo APFrmErrHelp::showErrors($errors, 'job_experience_id'); ?> </div>
    </div>
    <div class="col-md-6">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'career_level_id'); ?>">
			<label for=""><?php echo e(__('Career Level')); ?></label>
			<?php echo Form::select('career_level_id', [''=>__('Select Career Level')]+$careerLevels, null, array('class'=>'form-control', 'id'=>'career_level_id')); ?>
    ...
    <div class="col-md-6">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'industry_id'); ?>">
			<label for=""><?php echo e(__('Select Industry')); ?></label>
    ...
    <div class="col-md-6">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'functional_area_id'); ?>">
			<label for=""><?php echo e(__('Functional Area')); ?></label>
			<?php echo Form::select('functional_area_id', [''=>__('Select Functional Area')]+$functionalAreas, null, array('class'=>'form-control', 'id'=>'functional_area_id')); ?>

            <?php echo APFrmErrHelp::showErrors($errors, 'functional_area_id'); ?> </div>
    </div>
    <div class="col-md-4">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'current_salary'); ?>">
			<label for=""><?php echo e(__('Current Salary')); ?></label>
			<?php echo Form::text('current_salary', null, array('class'=>'form-control', 'id'=>'current_salary', 'placeholder'=>__('Current Salary'))); ?>

            <?php echo APFrmErrHelp::showErrors($errors, 'current_salary'); ?> </div>
    </div>
    <div class="col-md-4">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'expected_salary'); ?>">
			<label for=""><?php echo e(__('Expected Salary')); ?></label>
			<?php echo Form::text('expected_salary', null, array('class'=>'form-control', 'id'=>'expected_salary', 'placeholder'=>__('Expected Salary'))); ?>
    ...
    <div class="col-md-4">
        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'salary_currency'); ?>">
			<label for=""><?php echo e(__('Salary Currency')); ?></label>			
            <?php
