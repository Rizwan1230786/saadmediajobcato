                ...
                <ul class="optionlist view_more_ul">
                    <?php $__currentLoopData = $jobTitlesArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$jobTitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            ...
                            ?>
                            <input type="checkbox" class="job_title_filter" name="job_title[]" id="job_title_<?php echo e($key); ?>" value="<?php echo e($jobTitle); ?>" <?php echo e($checked); ?> >
                ...
                <ul class="optionlist view_more_ul">
                    <?php $__currentLoopData = $countryIdsArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$country_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if(null !== $country): ?>
                            ...
                            ?>
                            <li>
                                <input type="checkbox" class="country_filter" name="country_id[]" id="country_<?php echo e($country->country_id); ?>" value="<?php echo e($country->country_id); ?>" <?php echo e($checked); ?>>
                                <label for="country_<?php echo e($country->country_id); ?>"></label>
                                <?php echo e($country->country); ?> <span><?php echo e(App\Job::countNumJobs('country_id', $country->country_id)); ?></span>
                            </li>
                        <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
...
<?php /**PATH C:\xampp\htdocs\saadmediajobcato\resources\views/includes/job_list_side_bar.blade.php ENDPATH**/ ?>