                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <input type="text" name="search" value="<?php echo e(Request::get('search', '')); ?>"
                                class="form-control" placeholder="<?php echo e(__('Enter Skills, job title or Location')); ?>" />
                        </div>

                        <div class="col-lg-3">
                            <button type="submit" class="btn"><i class="fa fa-search" aria-hidden="true"></i>
                                <?php echo e(__('Search Jobs')); ?></button>
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\saadmediajobcato\resources\views/includes/inner_top_search.blade.php ENDPATH**/ ?>