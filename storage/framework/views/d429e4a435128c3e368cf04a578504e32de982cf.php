            ...
            <div class="col-md-6">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">
                        <?php echo Form::open(array('route' => 'store.admin.user', 'class' => 'form', 'novalidate' => 'novalidate')); ?>            
                        <?php echo $__env->make('admin.admin.add_edit_form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <div class="form-actions">
                            <?php echo Form::submit('Create New Admin User!', array('class'=>'btn blue')); ?>
