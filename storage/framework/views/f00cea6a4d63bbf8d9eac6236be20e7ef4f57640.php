    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <a href="<?php echo e(route('list.companies')); ?>">Companies</a> <i class="fa fa-circle"></i> </li>
            ...
            <div class="col-md-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">          
                        ...
                        <?php echo Form::open(array('method' => 'post', 'route' => 'store.company', 'class' => 'form', 'files'=>true)); ?>

                        <div class="tab-content">              
                            <div class="tab-pane fade active in" id="Details"> <?php echo $__env->make('admin.company.forms.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> </div>
                        </div>
                        <?php echo Form::close(); ?>
