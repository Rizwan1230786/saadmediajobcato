    ...
    <div class="searchbar">
		...
		<div class="row">
			<div class="col-lg-9 col-md-8">
				...
				<input type="text"  name="search" id="jbsearch" value="<?php echo e(Request::get('search', '')); ?>" class="form-control" placeholder="<?php echo e(__('Enter Skills or job title')); ?>" autocomplete="off" /></div>
			<div class="col-lg-3 col-md-4">
				<label for="">&nbsp;</label>
				<input type="submit" class="btn" value="<?php echo e(__('Search Job')); ?>"></div>
		</div>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\saadmediajobcato\resources\views/includes/search_form.blade.php ENDPATH**/ ?>